    ...
    public function run(): void
    {
        $rankings = [
            [
                ...
                'recommendation' => 'Review hari yang sama (Fast Track)',
                'sort_order' => 1,
                'is_active' => true,
            ],
            [
                ...
                'recommendation' => 'Review setelah Rank A',
                'sort_order' => 2,
                'is_active' => true,
            ],
            [
                ...
                'recommendation' => 'Review jika kapasitas tersedia',
                'sort_order' => 3,
                'is_active' => true,
            ],
            [
                ...
                'max_score' => 199,
                'priority_label' => 'Hold',
                'recommendation' => 'Hold / Reject / Review belakangan',
                'sort_order' => 4,
                'is_active' => true,
            ],
        ];
