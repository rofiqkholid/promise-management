...
class SystemFieldsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $fields = [
            ...
            ['field_key' => 'min_cost_rate', 'label' => 'Minimum Cost Rate (Master)', 'group' => 'ebd_process', 'data_type' => 'decimal', 'target_table' => 'mng_mfg_process_stp_costs', 'target_column' => 'min_cost_rate', 'is_required' => false],
            ['field_key' => 'stamping_cost', 'label' => 'Stamping Cost per Part (Calculated)', 'group' => 'ebd_process', 'data_type' => 'decimal', 'target_table' => null, 'target_column' => null, 'is_required' => false],
            ...
            ['field_key' => 'material_cost', 'label' => 'Total Material Cost (Matched)', 'group' => 'cost_comparison_item', 'data_type' => 'decimal', 'target_table' => 'mng_ebd_items', 'target_column' => null, 'is_required' => false],
            ...
            ['field_key' => 'mat_price_eng', 'label' => 'Material Price / Kg (Eng)', 'group' => 'cost_comparison_item', 'data_type' => 'decimal', 'target_table' => 'mng_material_costs', 'target_column' => 'price_per_kg', 'is_required' => false],
            ['field_key' => 'mat_price_sales', 'label' => 'Material Price / Kg (Sales)', 'group' => 'cost_comparison_item', 'data_type' => 'decimal', 'target_table' => 'mng_material_costs', 'target_column' => 'price_per_kg', 'is_required' => false],
            ['field_key' => 'mat_price_per_kg', 'label' => 'Material Price / Kg (Matched Master)', 'group' => 'cost_comparison_item', 'data_type' => 'decimal', 'target_table' => 'mng_material_costs', 'target_column' => 'price_per_kg', 'is_required' => false],
            ['field_key' => 'scrap_price_sales', 'label' => 'Scrap Price / Kg (Sales)', 'group' => 'cost_comparison_item', 'data_type' => 'decimal', 'target_table' => 'mng_material_costs', 'target_column' => 'scrap_price_per_kg', 'is_required' => false],
            ['field_key' => 'scrap_price_eng', 'label' => 'Scrap Price / Kg (Eng)', 'group' => 'cost_comparison_item', 'data_type' => 'decimal', 'target_table' => 'mng_material_costs', 'target_column' => 'scrap_price_per_kg', 'is_required' => false],
            ['field_key' => 'scrap_price_per_kg', 'label' => 'Scrap Price / Kg (Matched Master)', 'group' => 'cost_comparison_item', 'data_type' => 'decimal', 'target_table' => 'mng_material_costs', 'target_column' => 'scrap_price_per_kg', 'is_required' => false],
