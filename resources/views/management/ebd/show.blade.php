        ...
        <div class="flex flex-col gap-1.5 pr-6 border-r border-slate-200 dark:border-slate-700 flex-shrink-0">
            <div class="flex gap-1.5">
                ...
                <button type="button" id="btn-open-import-modal"
                        class="inline-flex items-center justify-center gap-2 px-3 h-8 bg-indigo-650 hover:bg-indigo-700 border border-transparent rounded-sm text-xs font-semibold text-white transition-all active:scale-98 cursor-pointer shadow-sm hover:shadow">
...
<div id="import-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40 backdrop-blur-sm">
    <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-2xl w-full max-w-lg mx-4 animate-fade-in">
        ...
        <div class="flex items-center justify-between px-5 py-4 border-b border-slate-200 dark:border-slate-700">
            <div>
                <h2 class="text-sm font-bold text-slate-800 dark:text-white">Import EBD File (New Revision)</h2>
                <p class="text-[11px] text-slate-400 dark:text-slate-500 mt-0.5">Upload an XLSX file to create a new EBD revision</p>
            </div>
            <button type="button" id="btn-close-import-modal"
                    class="w-7 h-7 flex items-center justify-center rounded-lg text-slate-400 hover:text-slate-655 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors cursor-pointer">
        ...
        <form id="form-import-ebd" enctype="multipart/form-data">
            ...
            <div class="px-5 py-4 space-y-4">
                ...
                <div class="bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-700 rounded-lg p-3 text-xs space-y-1.5 select-none">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="revision" id="input-revision"
                               value="{{ is_numeric($ebdHeader->revision) ? intval($ebdHeader->revision) + 1 : '' }}" placeholder="e.g. 0, 1, A"
                               class="w-full px-3 py-2 text-xs bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
                    </div>
                </div>
