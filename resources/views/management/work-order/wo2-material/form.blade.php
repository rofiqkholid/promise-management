    ...
    <div class="bg-white dark:bg-slate-800 rounded-sm shadow-2xl w-full max-w-md border border-slate-300 dark:border-slate-700">
        ...
        <form @submit.prevent="saveBomItem()" class="p-5 space-y-4 text-xs">
            ...
            <div>
                ...
                <input type="text" x-model="activeBom.mat_spec" placeholder="e.g. SPHC, SECC, SUS304..." class="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-800 dark:text-slate-100 text-xs px-2.5 py-1.5 rounded-sm focus:outline-none focus:border-blue-500">
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="text" x-model="activeBom.mat_size" placeholder="e.g. t1.2 x 1200 x 2400" class="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-800 dark:text-slate-100 text-xs px-2.5 py-1.5 rounded-sm focus:outline-none focus:border-blue-500">
                </div>
                <div>
                    ...
                    <input type="number" step="0.001" min="0" x-model="activeBom.mat_weight_pcs" placeholder="0.000" class="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-800 dark:text-slate-100 text-xs px-2.5 py-1.5 rounded-sm focus:outline-none focus:border-blue-500">
                </div>
            </div>
