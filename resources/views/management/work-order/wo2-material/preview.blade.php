                    ...
                    <table class="w-full text-center border-collapse border border-slate-900 text-xs">
                        <thead>
                            <tr class="divide-x divide-slate-900 border-b border-slate-900 font-bold bg-slate-50/50">
                                ...
                                <th class="p-1.5">Material Spec</th>
                                <th class="p-1.5">Material Size</th>
                                <th class="p-1.5 w-20">Weight/Pcs</th>
                        ...
                        <tbody>
                            ...
                            <template x-for="(prod, idx) in page.products" :key="idx">
                                <tr class="divide-x divide-y divide-slate-900 border-b border-slate-900 align-middle">
                                    ...
                                    <td class="p-1.5 font-semibold text-slate-800" x-text="prod.mat_spec || '—'"></td>
                                    <td class="p-1.5 font-semibold text-slate-800" x-text="prod.mat_size || '—'"></td>
                                    <td class="p-1.5 font-semibold text-right" x-text="(prod.mat_weight_pcs !== null && prod.mat_weight_pcs !== undefined && prod.mat_weight_pcs !== '') ? prod.mat_weight_pcs : '—'"></td>
