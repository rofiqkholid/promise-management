                    ...
                    <table class="w-full text-center border-collapse border border-slate-900 text-xs">
                        <thead>
                            <tr class="divide-x divide-slate-900 border-b border-slate-900 font-bold bg-slate-50/50">
                                ...
                                <th class="p-1.5">Std Part No</th>
                                <th class="p-1.5">Std Part Name</th>
                                <th class="p-1.5 w-12 text-center">Qty</th>
                                <th class="p-1.5 w-14 text-center">UOM</th>
                        ...
                        <tbody>
                            ...
                            <template x-for="(prod, idx) in page.products" :key="idx">
                                <tr class="divide-x divide-y divide-slate-900 border-b border-slate-900 align-middle">
                                    ...
                                    <td class="p-1.5 font-bold" x-text="prod.std_part_no || prod.customer_part_no"></td>
                                    <td class="p-1.5 text-left" x-text="prod.std_part_name || prod.customer_part_name"></td>
                                    <td class="p-1.5 text-center font-bold" x-text="prod.std_qty || '—'"></td>
                                    <td class="p-1.5 text-center" x-text="prod.std_uom || '—'"></td>
