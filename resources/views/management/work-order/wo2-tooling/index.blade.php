...
<div class="flex-1 overflow-y-auto p-4 pt-17.5 space-y-4 transition-colors duration-200">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-lg font-bold tracking-tight text-slate-800 dark:text-white">SPK 2 Tooling Cost</h1>
            <p class="text-xs text-slate-500 dark:text-slate-400">Manage Tooling Cost Work Orders (SPK 2)</p>
        </div>
