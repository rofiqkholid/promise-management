        ...
        <form @submit.prevent="saveBomItem()" class="p-5 space-y-4 text-xs">
            ...
            <div class="grid grid-cols-3 gap-2">
                <div>
                    ...
                    <input type="text" x-model="activeBom.eo" class="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-800 dark:text-slate-100 text-xs px-2.5 py-1.5 rounded-sm focus:outline-none focus:border-blue-500">
                </div>
                <div>
                    ...
                    <select x-model="activeBom.class_id" class="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-800 dark:text-slate-100 text-xs px-2.5 py-1.5 rounded-sm focus:outline-none focus:border-blue-500">
                ...
                <div>
                    ...
                    <select x-model="activeBom.uom" class="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-800 dark:text-slate-100 text-xs px-2.5 py-1.5 rounded-sm focus:outline-none focus:border-blue-500">
