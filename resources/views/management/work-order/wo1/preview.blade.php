                    ...
                    <table class="w-full text-center border-collapse border border-slate-900 text-xs">
                        <thead>
                            <tr class="divide-x divide-slate-900 border-b border-slate-900 font-bold bg-slate-50/50">
                                ...
                                <th class="p-1.5 w-8">EO</th>
                                <th class="p-1.5">Part Number</th>
                                <th class="p-1.5">Part Name</th>
                                <th class="p-1.5 w-12">Class ID</th>
                                <th class="p-1.5 w-12">UOM</th>
                                <th class="p-1.5 w-10">2D</th>
                                <th class="p-1.5 w-10">3D</th>
                                <th class="p-1.5 w-10">Tech</th>
                        ...
                        <tbody>
                            ...
                            <template x-for="(prod, idx) in page.products" :key="idx">
                                <tr class="divide-x divide-y divide-slate-900 border-b border-slate-900 align-middle">
                                    ...
                                    <td class="p-1.5" x-text="prod.eo"></td>
                                    <td class="p-1.5 font-bold" x-text="prod.customer_part_no"></td>
                                    <td class="p-1.5 text-left" x-text="prod.customer_part_name"></td>
                                    <td class="p-1.5 font-bold text-black" x-text="prod.class_id"></td>
                                    <td class="p-1.5" x-text="prod.uom"></td>
                                    <td class="p-1.5 font-semibold" x-text="prod.has_2d_data ? '✓' : '✗'" :class="prod.has_2d_data ? 'text-emerald-600 font-bold' : 'text-slate-455'"></td>
                                    <td class="p-1.5 font-semibold" x-text="prod.has_3d_data ? '✓' : '✗'" :class="prod.has_3d_data ? 'text-emerald-600 font-bold' : 'text-slate-455'"></td>
                                    <td class="p-1.5 font-semibold" x-text="prod.has_tech_doc ? '✓' : '✗'" :class="prod.has_tech_doc ? 'text-emerald-600 font-bold' : 'text-slate-455'"></td>
                        ...
                        <div class="text-xs text-slate-900">
                            <table class="w-full text-center border-collapse border border-slate-900 text-xs">
                                <thead>
                                    <tr class="divide-x divide-slate-900 border-b border-slate-900 font-bold bg-slate-50/50">
                                        <th class="p-1.5 w-8">No</th>
                                        <th class="p-1.5">SOP</th>
                                        <th class="p-1.5 w-24">Model Life</th>
                                        <th class="p-1.5">First Sample</th>
                                        <th class="p-1.5">DueDate (Plan)</th>
                                        <th class="p-1.5">DueDate Closed</th>
                                        <th class="p-1.5">Vol/Years</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="divide-x divide-y divide-slate-900 border-b border-slate-900 align-middle">
                                        ...
                                        <td class="p-1.5" x-text="products[0] && products[0].model_life ? (products[0].model_life + ' Years') : '—'"></td>
            ...
            <tbody>
                <template x-for="(prod, idx) in products" :key="idx">
                    <tr class="divide-x divide-y divide-slate-900 border-b border-slate-900 align-middle measure-product-row">
                        ...
                        <td class="p-1.5 font-bold text-black" x-text="prod.class_id"></td>
                        <td class="p-1.5" x-text="prod.uom"></td>
                        <td class="p-1.5 font-semibold" x-text="prod.has_2d_data ? '✓' : '✗'"></td>
                        <td class="p-1.5 font-semibold" x-text="prod.has_3d_data ? '✓' : '✗'"></td>
                        <td class="p-1.5 font-semibold" x-text="prod.has_tech_doc ? '✓' : '✗'"></td>
                        <td class="p-1.5 text-left" x-text="prod.remarks || '—'"></td>
                    </tr>
                </template>
            </tbody>
