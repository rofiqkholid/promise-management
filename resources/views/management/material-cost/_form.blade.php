    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div>
            ...
            <input type="text" name="material_spec" id="field-material_spec" list="list-specs"
                ...
                class="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-sm focus:ring-2 focus:ring-blue-500 font-semibold text-slate-800 dark:text-slate-200">
