...
<div class="space-y-4 text-xs">
    ...
    <div>
        ...
        <span class="text-[10px] text-slate-400 mt-1 block">Leave empty if this policy applies globally or as internal baseline.</span>
    </div>
    ...
    <div class="p-3 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-sm space-y-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
                <label class="block font-bold text-slate-700 dark:text-slate-300 mb-1">
                    O/H + Profit Rate (%) <span class="text-rose-500">*</span>
                </label>
            ...
            <div>
                <label class="block font-bold text-slate-700 dark:text-slate-300 mb-1">
                    Target Std Margin (%) <span class="text-rose-500">*</span>
                </label>
